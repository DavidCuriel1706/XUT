...
import Styles from './homeConfiguracion.module.css'

export const HomeConfiguracion = () => {
  return (
      ...
      <div className={Styles.contenedorAbajo}>
        ...
        <div className={Styles.contenedorIzquierda}>
            <div className={Styles.enlaces}>
              ...
              <Link to='/homeApis'>APIS</Link>
              <Link to='/homeConfiguracion' className={Styles.configuracion}>Configuracion</Link>
